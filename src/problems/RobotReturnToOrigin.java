...
4. Valid moves are R (right), L (left), U (up), and D (down)
5. If the robot returns to the origin after it finishes all of its moves, return true. Otherwise, return false
